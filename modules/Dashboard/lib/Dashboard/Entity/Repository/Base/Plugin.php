 ...
 *
 * This is the base repository class for plugin entities.
 */
class Dashboard_Entity_Repository_Base_Plugin extends EntityRepository
{
    /**
    ...
    public function truncateTable()
    {
        $query = $this->getEntityManager()
                 ->createQuery('DELETE Dashboard_Entity_Plugin');
        $query->execute();
    }
     ...
     *
     * @return array|Dashboard_Entity_Plugin retrieved data array or Dashboard_Entity_Plugin instance
     */
     ...
     * @param boolean $useJoins Whether to include joining related objects (optional) (default=true).
     *
     * @return ArrayCollection collection containing retrieved Dashboard_Entity_Plugin instances
     */
    ...
    public function selectSearch($fragment = '', $exclude = array(), $orderBy = '', $currentPage = 1, $resultsPerPage = 25, $useJoins = true)
    {
        ...
        $whereSub .= ((!empty($whereSub)) ? ' OR ' : '') . 'tbl.boxsize = \'' . $fragment . '\'';
        $whereSub .= ((!empty($whereSub)) ? ' OR ' : '') . 'tbl.pluginfile LIKE \'%' . $fragment . '%\'';
    ...
    public function selectCount($where = '', $useJoins = true)
    {
        ...
        $qb->select($selection)
           ->from('Dashboard_Entity_Plugin', 'tbl');
