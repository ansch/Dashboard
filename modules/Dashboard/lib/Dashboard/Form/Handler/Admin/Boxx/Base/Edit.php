 ...
 * It aims on the boxx object type.
 *
 * More documentation is provided in the parent class.
 */
class Dashboard_Form_Handler_Admin_Boxx_Base_Edit extends Dashboard_Form_Handler_Admin_Edit
{
    /**
    ...
    public function preInitialize()
    {
        ...
        $this->objectType = 'boxx';
        $this->objectTypeCapital = 'Boxx';
        $this->objectTypeLower = 'boxx';
    ...
    protected function getDefaultReturnUrl($args, $obj)
    {
        ...
        if ($args['commandName'] != 'delete' && !($this->mode == 'create' && $args['commandName'] == 'cancel')) {
            // redirect to the detail page of treated boxx
            $url = ModUtil::url($this->name, 'admin', 'display', array('ot' => 'boxx', 'id' => $this->idValues['id']));
        }
        return $url;
    }
    ...
    protected function getDefaultMessage($args, $success = false)
    {
        ...
        switch ($args['commandName']) {
            case 'create':
                $message = $this->__('Done! Boxx created.');
                break;
            case 'update':
                $message = $this->__('Done! Boxx updated.');
                break;
            case 'update':
                $message = $this->__('Done! Boxx deleted.');
                break;
        }
        return $message;
    }
