...
/**
 * This handler class handles the page events of the Form called by the Dashboard_admin_edit() function.
 * It aims on the plugins object type.
 *
 * More documentation is provided in the parent class.
 */
class Dashboard_Form_Handler_Admin_Plugins_Base_Edit extends Dashboard_Form_Handler_Admin_Edit
{
    /**
    ...
    public function preInitialize()
    {
        ...
        $this->objectType = 'plugins';
        $this->objectTypeCapital = 'Plugins';
        $this->objectTypeLower = 'plugins';
        $this->objectTypeLowerMultiple = 'plugins';
    ...
    {
        // redirect to the list of plugins
        $viewArgs = array('ot' => $this->objectType);
        $url = ModUtil::url($this->name, 'admin', 'view', $viewArgs);

        if ($args['commandName'] != 'delete' && !($this->mode == 'create' && $args['commandName'] == 'cancel')) {
            // redirect to the detail page of treated plugins
            $url = ModUtil::url($this->name, 'admin', 'display', array('ot' => 'plugins', 'id' => $this->idValues['id']));
        }
        return $url;
    }
    ...
    protected function getDefaultMessage($args, $success = false)
    {
        ...
        switch ($args['commandName']) {
            case 'create':
                $message = $this->__('Done! Plugins created.');
                break;
            case 'update':
                $message = $this->__('Done! Plugins updated.');
                break;
            case 'update':
                $message = $this->__('Done! Plugins deleted.');
                break;
        }
        return $message;
    }
