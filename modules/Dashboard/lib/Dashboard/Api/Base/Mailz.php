 ...
 */
class Dashboard_Api_Base_Mailz extends Zikula_AbstractApi
{
    /**
    ...
    public function getPlugins($args)
    {
        ...
        $plugins[] = array(
            'pluginid'    => 1,
            'module'      => 'Dashboard',
            'title'       => $this->__('3 newest boxes'),
            'description' => $this->__('A list of the three newest boxes.')
        );
        $plugins[] = array(
            'pluginid'    => 2,
            'module'      => 'Dashboard',
            'title'       => $this->__('3 random boxes'),
            'description' => $this->__('A list of three random boxes.')
        );
        return $plugins;
    }
