 ...
 */
class Dashboard_Controller_Base_Admin extends Zikula_AbstractController
{
    /**
     * Post initialise.
     *
     ...
     * @return mixed Output.
     */
    public function commonSettings($args)
    {
        // DEBUG: permission check aspect starts
        $this->throwForbiddenUnless(SecurityUtil::checkPermission('Dashboard::', '::', ACCESS_ADMIN));
        // DEBUG: permission check aspect ends
    ...
    public function updateCommonSettings($args)
    {
        ...
        // parameter specifying which type of objects we are treating
        $objectType = (isset($args['ot']) && !empty($args['ot'])) ? $args['ot'] : $this->request->getGet()->filter('ot', 'boxes', FILTER_SANITIZE_STRING);
        $utilArgs = array('controller' => 'admin', 'action' => 'updateCommonSettings');
        if (!in_array($objectType, Dashboard_Util_Controller::getObjectTypes('controllerAction', $utilArgs))) {
            $objectType = Dashboard_Util_Controller::getDefaultObjectType('controllerAction', $utilArgs);
        }
        /** TODO: custom logic */
        ...
        // return template
        return $this->view->fetch('admin/updateCommonSettings.tpl');
    }
    ...
    public function pluginsReload($args)
    {
        ...
        // return template
        return $this->view->fetch('admin/pluginsReload.tpl');
    }
    ...
    public function changePluginsState($args)
    {
        ...
        // return template
        return $this->view->fetch('admin/changePluginsState.tpl');
    }
    ...
    public function addBox($args)
    {
        ...
        // return template
        return $this->view->fetch('admin/addBox.tpl');
    }
     ...
     * @return mixed Output.
     */
    public function updateTables($args)
    {
        // DEBUG: permission check aspect starts
        $this->throwForbiddenUnless(SecurityUtil::checkPermission('Dashboard::', '::', ACCESS_ADMIN));
        // DEBUG: permission check aspect ends
        ...
        // parameter specifying which type of objects we are treating
        $objectType = (isset($args['ot']) && !empty($args['ot'])) ? $args['ot'] : $this->request->getGet()->filter('ot', 'boxes', FILTER_SANITIZE_STRING);
        $utilArgs = array('controller' => 'admin', 'action' => 'updateTables');
        if (!in_array($objectType, Dashboard_Util_Controller::getObjectTypes('controllerAction', $utilArgs))) {
            $objectType = Dashboard_Util_Controller::getDefaultObjectType('controllerAction', $utilArgs);
        }
        /** TODO: custom logic */
        ...
        // return template
        return $this->view->fetch('admin/updateTables.tpl');
    }
    ...
    public function edit($args)
    {
        ...
        $handlerClass = 'Dashboard_Form_Handler_Admin_' . ucfirst($objectType) . '_Edit';
    ...
    public function delete($args)
    {
        ...
        return Dashboard_Util_View::processTemplate($this->view, 'admin', $objectType, 'delete', $args);
    }
    ...
    public function view($args)
    {
        ...
        if ($tpl == 'tree') {
            ...
            $this->view->assign('trees', $trees)
                ->assign($repository->getAdditionalTemplateParameters('controllerAction', $utilArgs));
            // fetch and return the appropriate template
            return Dashboard_Util_View::processTemplate($this->view, 'admin', $objectType, 'view', $args);
        }
    ...
    public function display($args)
    {
        ...
        // fetch and return the appropriate template
        return Dashboard_Util_View::processTemplate($this->view, 'admin', $objectType, 'display', $args);
    }
    ...
    public function config()
    {
        ...
        // Execute form using supplied template and page event handler
        return $view->execute('admin/config.tpl', new Dashboard_Form_Handler_Admin_Config());
    }
}
