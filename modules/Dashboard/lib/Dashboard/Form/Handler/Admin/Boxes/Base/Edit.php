 ...
 */
class Dashboard_Form_Handler_Admin_Boxes_Base_Edit extends Dashboard_Form_Handler_Admin_Edit
{
    /**
    ...
    protected function getDefaultReturnUrl($args, $obj)
    {
        ...
        if ($args['commandName'] != 'delete' && !($this->mode == 'create' && $args['commandName'] == 'cancel')) {
            ...
            $url = ModUtil::url($this->name, 'admin', 'display', array('ot' => 'boxes', 'id' => $this->idValues['id']));
        }
        return $url;
    }
