 ...
 * It aims on the plugin object type.
 *
 * More documentation is provided in the parent class.
 */
class Dashboard_Form_Handler_Admin_Plugin_Base_Edit extends Dashboard_Form_Handler_Admin_Edit
{
    /**
    ...
    public function preInitialize()
    {
        ...
        $this->objectType = 'plugin';
        $this->objectTypeCapital = 'Plugin';
        $this->objectTypeLower = 'plugin';
    ...
    protected function getDefaultReturnUrl($args, $obj)
    {
        ...
        if ($args['commandName'] != 'delete' && !($this->mode == 'create' && $args['commandName'] == 'cancel')) {
            // redirect to the detail page of treated plugin
            $url = ModUtil::url($this->name, 'admin', 'display', array('ot' => 'plugin', 'id' => $this->idValues['id']));
        }
        return $url;
    }
    ...
    protected function getDefaultMessage($args, $success = false)
    {
        ...
        switch ($args['commandName']) {
            case 'create':
                $message = $this->__('Done! Plugin created.');
                break;
            case 'update':
                $message = $this->__('Done! Plugin updated.');
                break;
            case 'update':
                $message = $this->__('Done! Plugin deleted.');
                break;
        }
        return $message;
    }
