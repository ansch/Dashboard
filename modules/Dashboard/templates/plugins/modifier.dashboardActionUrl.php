...
/**
 * The dashboardActionUrl modifier creates the URL for a given action.
 *
 ...
 */
function smarty_modifier_dashboardActionUrl($urlType, $urlFunc, $urlArguments)
{
    return DataUtil::formatForDisplay(ModUtil::url('Dashboard', $urlType, $urlFunc, $urlArguments));
}
