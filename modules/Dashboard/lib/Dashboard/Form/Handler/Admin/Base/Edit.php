 ...
 */
class Dashboard_Form_Handler_Admin_Base_Edit extends Zikula_Form_AbstractHandler
{
    /**
    ...
    public function initialize(Zikula_Form_View $view)
    {
        ...
        $this->idValues = Dashboard_Util_Controller::retrieveIdentifier($this->request, array(), $this->objectType, $this->idFields);
        $hasIdentifier = Dashboard_Util_Controller::isValidIdentifier($this->idValues);
    ...
    public function HandleCommand(Zikula_Form_View $view, &$args)
    {
        ...
        $hookAreaPrefix = 'dashboard.ui_hooks.' . $this->objectTypeLowerMultiple;
