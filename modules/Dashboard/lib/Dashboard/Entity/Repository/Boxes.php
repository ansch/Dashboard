 ...
 *
 * This is the concrete repository class for boxes entities.
 */
class Dashboard_Entity_Repository_Boxes extends Dashboard_Entity_Repository_Base_Boxes
{
    /**
    ...
    public function truncateTable()
    {
        $query = $this->getEntityManager()
                 ->createQuery('DELETE Dashboard_Entity_Boxes');
        $query->execute();
    }
     ...
     *
     * @return array|Dashboard_Entity_Boxes retrieved data array or Dashboard_Entity_Boxes instance
     */
    ...
    public function selectSearch($fragment = '', $exclude = array(), $orderBy = '', $currentPage = 1, $resultsPerPage = 25, $useJoins = true)
    {
        ...
        $whereSub .= ((!empty($whereSub)) ? ' OR ' : '') . 'tbl.dbposition = \'' . $fragment . '\'';
    ...
    public function selectCount($where = '', $useJoins = true)
    {
        ...
        $qb->select($selection)
           ->from('Dashboard_Entity_Boxes', 'tbl');
