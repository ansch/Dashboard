 ...
 */
class Dashboard_Form_Handler_User_Plugin_Base_Edit extends Dashboard_Form_Handler_User_Edit
{
    /**
    ...
    protected function getDefaultReturnUrl($args, $obj)
    {
        ...
        if ($args['commandName'] != 'delete' && !($this->mode == 'create' && $args['commandName'] == 'cancel')) {
            ...
            $url = ModUtil::url($this->name, 'user', 'display', array('ot' => 'plugin', 'id' => $this->idValues['id']));
        }
        return $url;
    }
