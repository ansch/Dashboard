...
/**
 * The dashboardValidationError plugin returns appropriate (and multilingual)
 ...
 */
function smarty_function_dashboardValidationError($params, $view)
{
    $id = $params['id'];
    $class = $params['class'];
    ...
    switch ($class) {
        ...
        case 'validate-one-required':
            ...
            break;
        case 'validate-htmlcolour':
            $message = $view->__('Please select a valid html colour code.');
            break;
