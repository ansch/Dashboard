 ...
 */
class Dashboard_Util_Base_Controller extends Zikula_AbstractBase
{
    /**
     * Returns an array of all allowed object types in Dashboard.
     *
    ...
    public static function getObjectTypes($context = '', $args = array())
    {
        ...
        $allowedObjectTypes[] = 'boxes';
        $allowedObjectTypes[] = 'plugins';
        return $allowedObjectTypes;
    }

    /**
     * Returns the default object type in Dashboard.
     *
     * @param string $context Usage context (allowed values: controllerAction, api, actionHandler, block, contentType).
     * @param array  $args    Additional arguments.
     *
