 ...
 */
class Dashboard_Controller_Base_User extends Zikula_AbstractController
{
    /**
     * Post initialise.
     *
    ...
    public function view($args)
    {
        ...
        if ($tpl == 'tree') {
            ...
            return Dashboard_Util_View::processTemplate($this->view, 'user', $objectType, 'view', $args);
        }
    ...
    public function display($args)
    {
        ...
        // fetch and return the appropriate template
        return Dashboard_Util_View::processTemplate($this->view, 'user', $objectType, 'display', $args);
    }
    ...
    public function edit($args)
    {
        ...
        $handlerClass = 'Dashboard_Form_Handler_User_' . ucfirst($objectType) . '_Edit';
    ...
    public function addBox($args)
    {
        ...
        // parameter specifying which type of objects we are treating
        $objectType = (isset($args['ot']) && !empty($args['ot'])) ? $args['ot'] : $this->request->getGet()->filter('ot', 'boxes', FILTER_SANITIZE_STRING);
        $utilArgs = array('controller' => 'user', 'action' => 'addBox');
        if (!in_array($objectType, Dashboard_Util_Controller::getObjectTypes('controllerAction', $utilArgs))) {
            $objectType = Dashboard_Util_Controller::getDefaultObjectType('controllerAction', $utilArgs);
        }
        /** TODO: custom logic */
        ...
        // return template
        return $this->view->fetch('user/addBox.tpl');
    }
    ...
    public function switchPosition($args)
    {
        ...
        // parameter specifying which type of objects we are treating
        $objectType = (isset($args['ot']) && !empty($args['ot'])) ? $args['ot'] : $this->request->getGet()->filter('ot', 'boxes', FILTER_SANITIZE_STRING);
        $utilArgs = array('controller' => 'user', 'action' => 'switchPosition');
        if (!in_array($objectType, Dashboard_Util_Controller::getObjectTypes('controllerAction', $utilArgs))) {
            $objectType = Dashboard_Util_Controller::getDefaultObjectType('controllerAction', $utilArgs);
        }
        /** TODO: custom logic */
        ...
        // return template
        return $this->view->fetch('user/switchPosition.tpl');
    }
    ...
    public function reset($args)
    {
        ...
        // parameter specifying which type of objects we are treating
        $objectType = (isset($args['ot']) && !empty($args['ot'])) ? $args['ot'] : $this->request->getGet()->filter('ot', 'boxes', FILTER_SANITIZE_STRING);
        $utilArgs = array('controller' => 'user', 'action' => 'reset');
        if (!in_array($objectType, Dashboard_Util_Controller::getObjectTypes('controllerAction', $utilArgs))) {
            $objectType = Dashboard_Util_Controller::getDefaultObjectType('controllerAction', $utilArgs);
        }
        /** TODO: custom logic */
        ...
        // return template
        return $this->view->fetch('user/reset.tpl');
    }
