...
class Dashboard_Api_Base_User extends Zikula_AbstractApi
{
    ...
    public function getlinks()
    {
        ...
        if (SecurityUtil::checkPermission($this->name . '::', '::', ACCESS_READ)) {
            $links[] = array('url'   => ModUtil::url($this->name, 'user', 'view', array('ot' => 'boxx')),
                'text'  => $this->__('Boxes'),
                'title' => $this->__('Boxx list'));
        }
        if (SecurityUtil::checkPermission($this->name . '::', '::', ACCESS_READ)) {
            $links[] = array('url'   => ModUtil::url($this->name, 'user', 'view', array('ot' => 'plugin')),
                'text'  => $this->__('Plugins'),
                'title' => $this->__('Plugin list'));
        }
        return $links;
    }
    ...
    public function decodeurl($args)
    {
        ...
        $funcs = array('main', 'view', 'display', 'edit', 'delete', 'addBox', 'switchPosition', 'reset');
