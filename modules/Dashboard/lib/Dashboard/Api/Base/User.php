 ...
 * @version Generated by ModuleStudio 0.5.4 (http://modulestudio.de) at Sun Jun 03 13:43:04 CEST 2012.
 */

/**
 * This is the User api helper class.
 */
class Dashboard_Api_Base_User extends Zikula_AbstractApi
{
    /**
    ...
    public function getlinks()
    {
        ...
        if (SecurityUtil::checkPermission($this->name . '::', '::', ACCESS_READ)) {
            $links[] = array('url'   => ModUtil::url($this->name, 'user', 'view', array('ot' => 'boxes')),
                'text'  => $this->__('Boxes'),
                'title' => $this->__('Boxes list'));
        }
        if (SecurityUtil::checkPermission($this->name . '::', '::', ACCESS_READ)) {
            $links[] = array('url'   => ModUtil::url($this->name, 'user', 'view', array('ot' => 'plugins')),
    ...
    public function encodeurl($args)
    {
        ...
        $routerFacade = new Dashboard_RouterFacade();
        ...
        $allowedObjectTypes = Dashboard_Util_Controller::getObjectTypes('api', $utilArgs);
        $objectType = ((isset($args['args']['ot']) && in_array($args['args']['ot'], $allowedObjectTypes)) ? $args['args']['ot'] : Dashboard_Util_Controller::getDefaultObjectType('api', $utilArgs));
        ...
        $modInfo = ModUtil::getInfoFromName('Dashboard');
    ...
    public function decodeurl($args)
    {
        ...
        $funcs = array('main', 'view', 'display', 'edit', 'delete', 'addBox', 'switch', 'reset');
