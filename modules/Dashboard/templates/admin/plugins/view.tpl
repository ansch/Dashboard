...
<div class="z-admin-content-pagetitle">
    ...
    {checkpermissionblock component='Dashboard::' instance='.*' level="ACCESS_ADD"}
        ...
        <a href="{modurl modname='Dashboard' type='admin' func='edit' ot='plugins'}" title="{$createTitle}" class="z-icon-es-add">
            {$createTitle}
        </a>
    ...
    {if isset($showAllEntries) && $showAllEntries eq 1}
        ...
        <a href="{modurl modname='Dashboard' type='admin' func='view' ot='plugins'}" title="{$linkTitle}" class="z-icon-es-view">
            {$linkTitle}
        </a>
        {assign var='all' value=1}
    {else}
        {gt text='Show all entries' assign='linkTitle'}
        <a href="{modurl modname='Dashboard' type='admin' func='view' ot='plugins' all=1}" title="{$linkTitle}" class="z-icon-es-view">
            {$linkTitle}
        </a>
    {/if}
...
<table class="z-datatable">
    ...
    <tr>
        <th id="hactive" scope="col" class="z-right">
            {sortlink __linktext='Active' sort='active' currentsort=$sort sortdir=$sdir all=$all modname='Dashboard' type='admin' func='view' ot='plugins'}
        </th>
        <th id="hname" scope="col" class="z-left">
            {sortlink __linktext='Name' sort='name' currentsort=$sort sortdir=$sdir all=$all modname='Dashboard' type='admin' func='view' ot='plugins'}
        </th>
        <th id="htitle" scope="col" class="z-left">
            {sortlink __linktext='Title' sort='title' currentsort=$sort sortdir=$sdir all=$all modname='Dashboard' type='admin' func='view' ot='plugins'}
        </th>
        <th id="hdbsize" scope="col" class="z-right">
            {sortlink __linktext='Dbsize' sort='dbsize' currentsort=$sort sortdir=$sdir all=$all modname='Dashboard' type='admin' func='view' ot='plugins'}
        </th>
        <th id="hdbfile" scope="col" class="z-left">
            {sortlink __linktext='Dbfile' sort='dbfile' currentsort=$sort sortdir=$sdir all=$all modname='Dashboard' type='admin' func='view' ot='plugins'}
        </th>
        <th id="hajax" scope="col" class="z-right">
            {sortlink __linktext='Ajax' sort='ajax' currentsort=$sort sortdir=$sdir all=$all modname='Dashboard' type='admin' func='view' ot='plugins'}
        </th>
