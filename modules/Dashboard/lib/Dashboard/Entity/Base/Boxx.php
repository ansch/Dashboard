 ...
 *
 * This is the base entity class for boxx entities.
 *
 * @abstract
 */
abstract class Dashboard_Entity_Base_Boxx extends Zikula_EntityAccess
{

    /**
     * @var string The tablename this object maps to
     */
    protected $_objectType = 'boxx';
    ...
    /**
     * @var Dashboard_Entity_Validator_Boxx The validator for this entity
     */
     ...
     * Get _validator.
     *
     * @return Dashboard_Entity_Validator_Boxx
     */
     ...
     * Set _validator.
     *
     * @param Dashboard_Entity_Validator_Boxx $_validator.
     *
     * @return void
     */
    public function set_validator(Dashboard_Entity_Validator_Boxx $_validator = null)
    {
     ...
     * Set boxorder.
     *
     * @param bigint $boxorder.
     *
     * @return void
     */
    public function setBoxorder($boxorder)
    {
        if ($boxorder != $this->boxorder) {
     ...
     * Set boxdata.
     *
     * @param string $boxdata.
     *
     * @return void
     */
    public function setBoxdata($boxdata)
    {
        if ($boxdata != $this->boxdata) {
     ...
     *
     * @return Dashboard_Entity_Validator_Boxx The validator for this entity.
     */
    public function initValidator()
    {
        ...
        $this->_validator = new Dashboard_Entity_Validator_Boxx($this);
        return $this->_validator;
    }
    ...
    protected function prepareItemActions()
    {
        ...
        if ($currentType == 'admin') {
            if (in_array($currentFunc, array('main', 'view'))) {
                    $this->_actions[] = array(
                        'url' => array('type' => 'user', 'func' => 'display', 'arguments' => array('ot' => 'boxx', 'id' => $this['id'])),
                        'icon' => 'preview',
                        'linkTitle' => __('Open preview page', $dom),
                        'linkText' => __('Preview', $dom)
                    );
                    $this->_actions[] = array(
                        'url' => array('type' => 'admin', 'func' => 'display', 'arguments' => array('ot' => 'boxx', 'id' => $this['id'])),
                        'icon' => 'display',
            ...
            if (in_array($currentFunc, array('main', 'view', 'display'))) {
                if (SecurityUtil::checkPermission('Dashboard::', '.*', ACCESS_EDIT)) {
                    ...
                    $this->_actions[] = array(
                        'url' => array('type' => 'admin', 'func' => 'edit', 'arguments' => array('ot' => 'boxx', 'id' => $this['id'])),
                        'icon' => 'edit',
                        'linkTitle' => __('Edit', $dom),
                        'linkText' => __('Edit', $dom)
                    );
                    $this->_actions[] = array(
                        'url' => array('type' => 'admin', 'func' => 'edit', 'arguments' => array('ot' => 'boxx', 'astemplate' => $this['id'])),
                        'icon' => 'saveas',
                ...
                if (SecurityUtil::checkPermission('Dashboard::', '.*', ACCESS_DELETE)) {
                    $this->_actions[] = array(
                        'url' => array('type' => 'admin', 'func' => 'delete', 'arguments' => array('ot' => 'boxx', 'id' => $this['id'])),
                        'icon' => 'delete',
            ...
            if ($currentFunc == 'display') {
                    $this->_actions[] = array(
                        'url' => array('type' => 'admin', 'func' => 'view', 'arguments' => array('ot' => 'boxx')),
                        'icon' => 'back',
        ...
        if ($currentType == 'user') {
            ...
            if (in_array($currentFunc, array('main', 'view', 'display'))) {
                if (SecurityUtil::checkPermission('Dashboard::', '.*', ACCESS_EDIT)) {
                    ...
                    $this->_actions[] = array(
                        'url' => array('type' => 'user', 'func' => 'edit', 'arguments' => array('ot' => 'boxx', 'id' => $this['id'])),
                        'icon' => 'edit',
                        'linkTitle' => __('Edit', $dom),
                        'linkText' => __('Edit', $dom)
                    );
                    $this->_actions[] = array(
                        'url' => array('type' => 'user', 'func' => 'edit', 'arguments' => array('ot' => 'boxx', 'astemplate' => $this['id'])),
                        'icon' => 'saveas',
                        'linkTitle' => __('Reuse for new item', $dom),
                        'linkText' => __('Reuse', $dom)
                    );
                ...
                if (SecurityUtil::checkPermission('Dashboard::', '.*', ACCESS_DELETE)) {
                    $this->_actions[] = array(
                        'url' => array('type' => 'user', 'func' => 'delete', 'arguments' => array('ot' => 'boxx', 'id' => $this['id'])),
                        'icon' => 'delete',
                        'linkTitle' => __('Delete', $dom),
                        'linkText' => __('Delete', $dom)
                    );
            ...
            if ($currentFunc == 'display') {
                    $this->_actions[] = array(
                        'url' => array('type' => 'user', 'func' => 'view', 'arguments' => array('ot' => 'boxx')),
                        'icon' => 'back',
                        'linkTitle' => __('Back to overview', $dom),
                        'linkText' => __('Back to overview', $dom)
                    );
     ...
     *
     * @see Dashboard_Entity_Boxx::postLoadCallback()
    ...
    protected function performPostLoadCallback()
    {
        ...
        $this['boxorder'] = (int) ((isset($this['boxorder']) && !empty($this['boxorder'])) ? DataUtil::formatForDisplay($this['boxorder']) : 0);
    ...
    if ($currentFunc != 'edit') {
        $this['boxdata'] = ((isset($this['boxdata']) && !empty($this['boxdata'])) ? DataUtil::formatForDisplayHTML($this['boxdata']) : '');
    }
     ...
     *
     * @see Dashboard_Entity_Boxx::prePersistCallback()
     * @return boolean true if completed successfully else false.
     */
     ...
     *     - no access to entity manager or unit of work apis
     *
     * @see Dashboard_Entity_Boxx::postPersistCallback()
     * @return boolean true if completed successfully else false.
     */
     ...
     *
     * @see Dashboard_Entity_Boxx::preRemoveCallback()
     * @return boolean true if completed successfully else false.
     */
...
/*        // delete workflow for this entity
     ...
     *     - will not be called for a DQL DELETE statement
     *
     * @see Dashboard_Entity_Boxx::postRemoveCallback()
     * @return boolean true if completed successfully else false.
     */
     ...
     *     - no creation of other entities allowed
     *
     * @see Dashboard_Entity_Boxx::preUpdateCallback()
     * @return boolean true if completed successfully else false.
     */
     ...
     *     - will not be called for a DQL UPDATE statement
     *
     * @see Dashboard_Entity_Boxx::postUpdateCallback()
     * @return boolean true if completed successfully else false.
     */
     ...
     *
     * @see Dashboard_Entity_Boxx::preSaveCallback()
     * @return boolean true if completed successfully else false.
     */
     ...
     * For more information see corresponding callback handlers.
     *
     * @see Dashboard_Entity_Boxx::postSaveCallback()
     * @return boolean true if completed successfully else false.
     */
