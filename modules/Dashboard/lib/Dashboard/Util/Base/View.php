 ...
 */
class Dashboard_Util_Base_View extends Zikula_AbstractBase
{
    /**
    ...
    protected static function processPdf(Zikula_View $view, $template)
    {
        ...
        $fileTitle = Dashboard_Util_Controller::formatPermalink(System::getVar('sitename'))
            . '-'
            . Dashboard_Util_Controller::formatPermalink(PageUtil::getVar('title'))
            . '-' . date('Ymd') . '.pdf';
