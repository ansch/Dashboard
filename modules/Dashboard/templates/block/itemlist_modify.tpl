...
<div class="z-formrow">
    <label for="Dashboard_sorting">{gt text='Sorting'}:</label>
    <select id="Dashboard_sorting" name="sorting">
...
<div class="z-formrow">
    <label for="Dashboard_amount">{gt text='Amount'}:</label>
    <input type="text" id="Dashboard_amount" name="amount" size="10" value="{$amount|default:"5"}" />
</div>

<div class="z-formrow">
    <label for="Dashboard_template">{gt text='Template File'}:</label>
    <select id="Dashboard_template" name="template">
...
<div class="z-formrow">
    <label for="Dashboard_filter">{gt text='Filter (expert option)'}:</label>
    <input type="text" id="Dashboard_filter" name="filter" size="40" value="{$filterValue|default:""}" />
