 ...
 *
 * This is the base entity class for plugins entities.
 *
 * @abstract
 */
abstract class Dashboard_Entity_Base_Plugins extends Zikula_EntityAccess
{

    /**
     * @var string The tablename this object maps to
     */
    protected $_objectType = 'plugins';
    ...
    /**
     * @var Dashboard_Entity_Validator_Plugins The validator for this entity
     */
     ...
     *
     * @return Dashboard_Entity_Validator_Plugins The validator for this entity.
     */
    public function initValidator()
    {
        ...
        $this->_validator = new Dashboard_Entity_Validator_Plugins($this);
        return $this->_validator;
    }
    ...
    protected function prepareItemActions()
    {
        ...
        if ($currentType == 'admin') {
            if (in_array($currentFunc, array('main', 'view'))) {
                    $this->_actions[] = array(
                        'url' => array('type' => 'user', 'func' => 'display', 'arguments' => array('ot' => 'plugins', 'id' => $this['id'])),
                        'icon' => 'preview',
                        'linkTitle' => __('Open preview page', $dom),
                        'linkText' => __('Preview', $dom)
                    );
                    $this->_actions[] = array(
                        'url' => array('type' => 'admin', 'func' => 'display', 'arguments' => array('ot' => 'plugins', 'id' => $this['id'])),
                        'icon' => 'display',
            ...
            if (in_array($currentFunc, array('main', 'view', 'display'))) {
                if (SecurityUtil::checkPermission('Dashboard::', '.*', ACCESS_EDIT)) {
                    ...
                    $this->_actions[] = array(
                        'url' => array('type' => 'admin', 'func' => 'edit', 'arguments' => array('ot' => 'plugins', 'id' => $this['id'])),
                        'icon' => 'edit',
                        'linkTitle' => __('Edit', $dom),
                        'linkText' => __('Edit', $dom)
                    );
                    $this->_actions[] = array(
                        'url' => array('type' => 'admin', 'func' => 'edit', 'arguments' => array('ot' => 'plugins', 'astemplate' => $this['id'])),
                        'icon' => 'saveas',
                ...
                if (SecurityUtil::checkPermission('Dashboard::', '.*', ACCESS_DELETE)) {
                    $this->_actions[] = array(
                        'url' => array('type' => 'admin', 'func' => 'delete', 'arguments' => array('ot' => 'plugins', 'id' => $this['id'])),
                        'icon' => 'delete',
            ...
            if ($currentFunc == 'display') {
                    $this->_actions[] = array(
                        'url' => array('type' => 'admin', 'func' => 'view', 'arguments' => array('ot' => 'plugins')),
                        'icon' => 'back',
        ...
        if ($currentType == 'user') {
            ...
            if (in_array($currentFunc, array('main', 'view', 'display'))) {
                if (SecurityUtil::checkPermission('Dashboard::', '.*', ACCESS_EDIT)) {
                    ...
                    $this->_actions[] = array(
                        'url' => array('type' => 'user', 'func' => 'edit', 'arguments' => array('ot' => 'plugins', 'id' => $this['id'])),
                        'icon' => 'edit',
                        'linkTitle' => __('Edit', $dom),
                        'linkText' => __('Edit', $dom)
                    );
                    $this->_actions[] = array(
                        'url' => array('type' => 'user', 'func' => 'edit', 'arguments' => array('ot' => 'plugins', 'astemplate' => $this['id'])),
                        'icon' => 'saveas',
                        'linkTitle' => __('Reuse for new item', $dom),
                        'linkText' => __('Reuse', $dom)
                    );
                ...
                if (SecurityUtil::checkPermission('Dashboard::', '.*', ACCESS_DELETE)) {
                    $this->_actions[] = array(
                        'url' => array('type' => 'user', 'func' => 'delete', 'arguments' => array('ot' => 'plugins', 'id' => $this['id'])),
                        'icon' => 'delete',
                        'linkTitle' => __('Delete', $dom),
                        'linkText' => __('Delete', $dom)
                    );
            ...
            if ($currentFunc == 'display') {
                    $this->_actions[] = array(
                        'url' => array('type' => 'user', 'func' => 'view', 'arguments' => array('ot' => 'plugins')),
                        'icon' => 'back',
                        'linkTitle' => __('Back to overview', $dom),
                        'linkText' => __('Back to overview', $dom)
                    );
     ...
     *
     * @see Dashboard_Entity_Plugins::postLoadCallback()
    ...
    if ($currentFunc != 'edit') {
        ...
        $this['dbsize'] = (int) ((isset($this['dbsize']) && !empty($this['dbsize'])) ? DataUtil::formatForDisplay($this['dbsize']) : 0);
    if ($currentFunc != 'edit') {
        $this['dbfile'] = ((isset($this['dbfile']) && !empty($this['dbfile'])) ? DataUtil::formatForDisplayHTML($this['dbfile']) : '');
    }
     ...
     *
     * @see Dashboard_Entity_Plugins::prePersistCallback()
     * @return boolean true if completed successfully else false.
     */
     ...
     *     - no access to entity manager or unit of work apis
     *
     * @see Dashboard_Entity_Plugins::postPersistCallback()
     * @return boolean true if completed successfully else false.
     */
     ...
     *
     * @see Dashboard_Entity_Plugins::preRemoveCallback()
     * @return boolean true if completed successfully else false.
     */
...
/*        // delete workflow for this entity
     ...
     *     - will not be called for a DQL DELETE statement
     *
     * @see Dashboard_Entity_Plugins::postRemoveCallback()
     * @return boolean true if completed successfully else false.
     */
     ...
     *     - no creation of other entities allowed
     *
     * @see Dashboard_Entity_Plugins::preUpdateCallback()
     * @return boolean true if completed successfully else false.
     */
     ...
     *     - will not be called for a DQL UPDATE statement
     *
     * @see Dashboard_Entity_Plugins::postUpdateCallback()
     * @return boolean true if completed successfully else false.
     */
     ...
     *
     * @see Dashboard_Entity_Plugins::preSaveCallback()
     * @return boolean true if completed successfully else false.
     */
     ...
     * For more information see corresponding callback handlers.
     *
     * @see Dashboard_Entity_Plugins::postSaveCallback()
     * @return boolean true if completed successfully else false.
     */
