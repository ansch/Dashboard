 ...
 */
class Dashboard_ContentType_Base_ItemList extends Content_AbstractContentType
{
    private $objectType;
    private $sorting;
    private $amount;
    ...
    public function getTitle()
    {
        ...
        return __('Dashboard items', $dom);
    }

    public function getDescription()
    {
        $dom = ZLanguage::getModuleDomain('Dashboard');
        return __('Display Dashboard items.', $dom);
    }

    public function loadData(&$data)
    {
        if (!isset($data['objectType']) || !in_array($data['objectType'], Dashboard_Util_Controller::getObjectTypes('contentType'))) {
            $data['objectType'] = Dashboard_Util_Controller::getDefaultObjectType('contentType');
        }
    ...
    public function display()
    {
        ...
        $repository = $entityManager->getRepository('Dashboard_Entity_' . ucfirst($this->objectType));
    ...
    {
        $dom = ZLanguage::getModuleDomain('Dashboard');
        array_push($this->view->plugins_dir, 'modules/Dashboard/templates/plugins');
    }
}
